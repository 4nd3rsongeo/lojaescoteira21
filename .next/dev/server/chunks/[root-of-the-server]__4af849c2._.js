...
"[project]/src/lib/prisma.ts [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                try {
                    ...
                    const isValid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].compare(credentials.password, user.password);
                    if (!isValid) {
...
;
;
const proxy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["auth"])((req)=>{
    const { nextUrl } = req;
    ...
    if (!isLoggedIn) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/login", nextUrl));
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4af849c2._.js.map